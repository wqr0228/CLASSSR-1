...
def main():
    ...
    if mode == 'pair':
        # cut training data
        GT_folder = r'E:\Code\Python\datas\RS\WHU-RS19-train\HR\x4'# fix to your path
        LR_folder = r'E:\Code\Python\datas\RS\WHU-RS19-train\LR\x4'# fix to your path
        save_GT_folder = r'E:\Code\Python\datas\RS\WHU-RS19-train/WHURS19_scale_sub/GT'
        save_LR_folder = r'E:\Code\Python\datas\RS\WHU-RS19-train/WHURS19_scale_sub/LR'
